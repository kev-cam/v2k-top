...
#undef  acc_user_h_rcsid
#define acc_user_h_rcsid() {return "$Id: acc_user.h,v 1.9 2007/03/28 07:22:07 dkc Exp $";} /* RCS ID */
...
extern bool acc_error_flag; typedef int (*consumer_function)();
